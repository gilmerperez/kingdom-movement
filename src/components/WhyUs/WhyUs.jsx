          ...
          <div className={styles.benefitsGrid}>
            ...
            <div ref={addCardRef} className={styles.benefitCard}>
              ...
              <p className={styles.cardText}>
                Nutritious meals, nutrition plans and one on one coaching when it comes to a custom made wellness
                profile so we can achieve your personal goals. Our certified nutrition experts work with you to develop
            ...
            <div ref={addCardRef} className={styles.benefitCard}>
              ...
              <p className={styles.cardText}>
                We offer classes throughout the entire day as well as open gym sessions where you can come in and get
                some work done. Our classes are specially made following workouts that elite and professional level
            ...
            <div ref={addCardRef} className={styles.benefitCard}>
              ...
              <p className={styles.cardText}>
                Access to our special events that we host, this can include anything from a special Saturday workout
                class in a special location, to a weekend getaway in nature, to parties and celebrations for any
